...
## Assignment 3 - Using Dapr for pub/sub with a Message Broker
...
Follow this link to access the assignment: [Using Dapr for pub/sub with a Message Broker](https://azure.github.io/dapr-java-workshop/modules/3-Module/)
